...
if (file_exists($root . '/modules/')) {
	...
	$command = '"/Applications/Google Chrome.app/Contents/MacOS/Google Chrome" --headless --screenshot="%s" --window-size=800,600 --default-background-color=0 %s';
	...
	echo "Please move to the root sleek folder\n";
}
